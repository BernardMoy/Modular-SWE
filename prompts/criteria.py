...
- Refactoring should be considered when there are significant duplication of business logic across modules, such that a likely change requires coordination. 

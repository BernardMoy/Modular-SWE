...
from metrics.deps_graph.smells.unstable_dependency_checker import (
    check_unstable_dependency,
)
from metrics.deps_graph.smells.hub_like_modularisation_checker import (
    check_hub_like_modularisation,
)

            ...
            smells.append(
                {
                    ...
                    "Smell": "Complex method",
                    "Description": (
                        f"The method has cyclomatic complexity of {entry['CC']}, worth inspecting its readability and testability."
                        if entry["CC"] < 20
                        else f"The method has high cyclomatic complexity of {entry['CC']}, check if the logic can be refactored into smaller, more readable functions."
                    ),
                }
            )

...
from ..settings import WORKFLOW_MODE, AGENT, MODEL, PROBLEM_TYPE, UI_ENABLED, SIGN_IN_METHOD, DEMO_MODE
...
DEMO_WORKSPACE = Path("agent_workspace_demo_question")
...
def modular_workflow_single(
    ...
    if DEMO_MODE: 
        ...
        shutil.copytree(DEMO_WORKSPACE, AGENT_WORKSPACE)

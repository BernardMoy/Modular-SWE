...
PROBLEMS = ["code_search"] # , "circuit_eval", "mocked_http", "recli", "sheeteval", "sith", "eve_industry", "metric_transform_lang"]
...
def get_scb_metrics_json(): 
    ...
    for problem in PROBLEMS: 
        ...
        for impl_name in os.listdir(problem_path): 
            ...
            impl_checkpoints_paths = sorted([os.path.join(impl_path, n) for n in os.listdir(impl_path)])
...
def main():
    ...
    parser.add_argument(
        "output_dir", help="Output json file"
    )
